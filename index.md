...
For this semester, I had planned on attending a tech meeting in Charleston in order to write about it for this blog post. However, with the covid-19 shutdown of Charleston and social distancing in place, I will instead talk about my experience with a Capture the Flag style challenge I took part in this semester with the [https://www.nationalcyberleague.org/](National Cyber League). 

The National Cyber League is a cyber security competition for High School and College students which consists of challenges that showcase their ability to "identify hackers from forensic data, break into vulnerable websites, recover from ransomware attacks, and more." It's a good way to test your cybersecurity knowledge against other people around the same skill level. But not only that, it's also a great learning tool that teaches you as you compete. I myself learned of a number of valuable tools for cryptography, decrypting, password cracking, network scanning, and website exploitation that I would not have encountered otherwise.

After paying the $35 entrance fee, you're granted access to the "Gymnasium", which consists of practice challenges to test your skills with. This gives you a good preview of the format of the final competition, with challenges focusing on different aspects of cybersecurity. Initially you start with Open Source Intelligence challenges, which tests your ability to find information, AKA how to use Google. This could include anything from finding out who a domain name is registered to, to what tax code a certain organization is classified as. From there it only gets more technical, with password cracking, wireless network exploitation, and more. I learned more about the practical application of cybersecurity knowledge from this program than I have from my years of Computer Science experience earning my degree. 

To begin with, there was a Preseason game the week before the competition. This game was meant to assess the players current aptitude and place them in a bracket compatible with their skill level. The skill brackets were Bronze, Silver, or Gold, all based on the amount of points the player earned by completing challenges during the preseason. I myself placed in the Silver bracket, which is about where I felt myself to be with the current level of cyber security knowledge I have. The challenge itself took place over the weekend of April 3rd-5th. Each player had just 36 hours to solve as many challenges as possible to earn points towards their total. I think I spent 12+ hours on the challenges over the weekend just trying pushing my score, and learning more along the way. 

As for tackling the challenges, I used [Kali Linux](https://www.kali.org) on my Windows 10 desktop with [Virtual Box](https://www.virtualbox.org), which comes preinstalled with tools for cybersecurity and network exploration. Password cracking in particular was especially challenging for me. The tool I used was John the Ripper. The only way to crack passwords within the allotted time was to implement your own rules based on the clues each challenge mentioned. For example, there was a challenge that mentioned the [RockYou](https://techcrunch.com/2009/12/14/rockyou-hack-security-myspace-facebook-passwords/) hack from 2009, so I was required to make a rule that used the wordlist from the RockYou hack in order to find the passwords from the hash of the user's passwords. This was just the tip of the proverbial iceberg, but overall I recommend anyone interested in cybersecurity to pursue these types of capture the flag challenges in order to expand their repertoire of tools for tackling security problems. 
